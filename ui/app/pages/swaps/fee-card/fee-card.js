    ...
    <div className="fee-card">
      <div className="fee-card__main">
        <div className="fee-card__row-header">
          <div>
            <div className="fee-card__row-header-text--bold">{feeRowText}</div>
          </div>
          <div>
        ...
        <div
          ...
          onClick={() => maxFeeRow.onClick()}
        >
          <div>
            <div className="fee-card__row-header-text">{maxFeeRow.text}</div>
            <div className="fee-card__link">{maxFeeRow.linkText}</div>
            <div className="fee-card__row-label">
              <InfoTooltip position="top" contentText={maxFeeRow.tooltipText} />
            </div>
          </div>
          <div>
        ...
        {thirdRow && !thirdRow.hide && (
          <div className="fee-card__top-bordered-row">
            <div className="fee-card__row-label">
              <div className="fee-card__row-header-text">{thirdRow.text}</div>
              <div
                className="fee-card__link"
                onClick={() => thirdRow.onClick()}
              >
                {thirdRow.linkText}
              </div>
              <InfoTooltip position="top" contentText={thirdRow.tooltipText} />
            </div>
          </div>
        )}
      </div>
