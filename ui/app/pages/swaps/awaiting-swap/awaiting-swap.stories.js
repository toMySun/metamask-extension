...
export const swapNotComplete = () => (
  <div style={{ height: '528px', width: '357px', border: '1px solid grey' }}>
    <AwaitingSwap
      ...
      rpcPrefs={{
        blockExplorerUrl: text('blockExplorerUrl 1', 'http://example.com'),
      }}
    />
  </div>
)
...
export const swapComplete = () => (
  <div style={{ height: '528px', width: '357px', border: '1px solid grey' }}>
    <AwaitingSwap
      ...
      txHash="0xnotATx"
      rpcPrefs={{
        blockExplorerUrl: text('blockExplorerUrl 2', 'http://example.com'),
      }}
    />
  </div>
)
...
export const swapError = () => (
  <div style={{ height: '528px', width: '357px', border: '1px solid grey' }}>
    <AwaitingSwap
      ...
      txHash="0xnotATx"
      rpcPrefs={{
        blockExplorerUrl: text('blockExplorerUrl 3', 'http://example.com'),
      }}
    />
  </div>
)
